...
namespace MeGUI
{
	...
	public class AviSynthWindow : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button avsConfigButton;
        ...
        public AviSynthWindow(MeGUI mainForm)
        {
			...
			template = "";
            foreach (string name in this.mainForm.Profiles.AvsProfiles.Keys)
            {
		...
		public AviSynthWindow(MeGUI mainForm, string videoInput) : this(mainForm)
		{
		...
		{
            mainForm.Settings.AvsProfileName = avsProfile.Text;
            if (player != null)
				player.Close();
            if (detector != null)
                detector.stop();
		...
		private void InitializeComponent()
		{
            ...
            this.videoGroupBox.Controls.Add(this.avsConfigButton);
            this.videoGroupBox.Controls.Add(this.avsProfile);
            this.videoGroupBox.Controls.Add(this.avsProfileLabel);
            ...
            // avsConfigButton
            // 
            this.avsConfigButton.Location = new System.Drawing.Point(331, 112);
            ...
            this.avsProfile.Location = new System.Drawing.Point(96, 106);
            this.avsProfile.Name = "avsProfile";
            this.avsProfile.Size = new System.Drawing.Size(224, 21);
            this.avsProfile.Sorted = true;
            this.avsProfile.TabIndex = 17;
            ...
            // videoInput
            // 
            this.videoInput.Location = new System.Drawing.Point(96, 24);
            this.videoInput.Name = "videoInput";
            this.videoInput.ReadOnly = true;
            this.videoInput.Size = new System.Drawing.Size(248, 21);
            ...
            this.videoInputLabel.Size = new System.Drawing.Size(80, 23);
            ...
            // flipVertical
            // 
            this.flipVertical.Location = new System.Drawing.Point(6, 20);
            ...
            this.noiseFilterType.Location = new System.Drawing.Point(152, 44);
            ...
            // noiseFilter
            // 
            this.noiseFilter.Location = new System.Drawing.Point(5, 44);
            ...
            this.resizeFilterType.Location = new System.Drawing.Point(152, 17);
            ...
            // resizeFilterLabel
            // 
            this.resizeFilterLabel.Location = new System.Drawing.Point(21, 17);
            ...
            this.Text = "MeGUI - AviSynth script generator";
		...
		private string generateScript()
		{
            ...
            string newScript = ScriptServer.CreateScriptFromTemplate(template, inputLine, cropLine, resizeLine, denoiseLines, deinterlaceLines);
        ...
        private void openDirectShow(string fileName)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        reader = AvsReader.ParseScript("AviFileSource(\"" + fileName + "\")"); // new AVIReader(fileName);
                    }
                    ...
                    string tempAvs = string.Format(
                            ...
                            fileName,
                            reader == null ? string.Empty : (", fps=" + reader.Framerate.ToString(System.Globalization.CultureInfo.InvariantCulture)),
        ...
        private void gotoD2vCreator(string fileName)
        {
            ...
            {
                if (mainForm.startEncoding(mpegInput.LastJob))
                {
                    mainForm.QueueEncoding = false;
                }
                else
                {
		...
		private void openVideo(string videoInput, string textBoxName, bool inlineAvs)
		{
			...
			if (videoLoaded)
			{
                ...
                this.fpsBox.Text = reader.Framerate.ToString(ci);
				if (reader.Framerate.Equals(25.0)) // disable ivtc for pal sources
					this.tvTypeLabel.Text = "PAL";
				else
					this.tvTypeLabel.Text = "NTSC";
				horizontalResolution.Maximum = reader.Width;
				verticalResolution.Maximum = reader.Height;
                if (reader is d2vReader)
                {
                    d2vReader temp = (d2vReader)reader;
                    inputDAR.SelectedIndex = temp.AR;
                }
                else
                {
                    inputDAR.SelectedIndex = 3; // Custom
                    customDAR.Text = Math.Round(((double)((double)reader.Width / (double)reader.Height)), 4).ToString();
                }
				player.Show();
				this.showScript();
			}
		...
		private void inputDAR_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			switch (inputDAR.SelectedIndex)
			{
				...
				case 2:
					...
					break;
				case 3:
					dar = 2.35; // probably the most common custom DAR that will be used
                    break;
			}
        ...
        void fpsBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Single.TryParse(fpsBox.Text, out result))
                fpsBox.Text = reader.Framerate.ToString();
            this.showScript();
        }
        #endregion
        #region profiles
        private void avsConfigButton_Click(object sender, System.EventArgs e)
		{
			avsConfigurationDialog acd = new avsConfigurationDialog(this.mainForm.Profiles, avsProfile.Text, this.path, 
				MeGUISettings.AvisynthPluginsPath);
			acd.Settings = new AviSynthSettings();
