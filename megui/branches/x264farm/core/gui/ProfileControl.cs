...
namespace MeGUI.core.details.video
{
    ...
    public delegate IDictionary<string, Profile> DictionaryGetter();
    ...
    public interface IProfileList
    {
        ...
        /// <summary>
        /// Returns the profile by a given name, name
        /// </summary>
    ...
    public class DictionaryProfileList : IProfileList
    {
        ...
        {
            get {
                Profile[] val = new Profile[get().Values.Count];
                get().Values.CopyTo(val, 0);
                return val;
            }
        }
        ...
        public DictionaryProfileList(DictionaryGetter getter)
        {
            this.get = getter;
        }
        ...
        where TSettings : GenericSettings
    {
        ...
        public IProfileList ProfileList
        {
            set { profileList = value;
                RefreshProfiles(); }
        }

        private IDictionary<string, Profile> getDictionary()
        {
            return mainForm.Profiles.Profiles(profileType);
        }
            ...
            SettingsSetter<TSettings> setter)
        {
            ...
            profileList = new DictionaryProfileList(new DictionaryGetter(getDictionary));
            impl = p;
            RefreshProfiles();
        }
    }
