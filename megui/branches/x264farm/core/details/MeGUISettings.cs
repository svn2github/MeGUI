...
namespace MeGUI
{
	...
	public class MeGUISettings
    {
        ...
        private string faacPath, lamePath, neroAacEncPath, mencoderPath,  mp4boxPath, mkvmergePath, encAacPlusPath,
            ...
            x264Path, x264farmControllerPath, dgIndexPath, xvidEncrawPath, avc2aviPath, aviMuxGUIPath, oggEnc2Path, encAudXPath,
        ...
        public MeGUISettings()
		{
			...
			x264Path = "x264.exe";
            x264farmControllerPath = "controller.exe";
        ...
        /// <summary>
        /// filename and full path of the x264farm controller executable
        /// </summary>
        public string X264farmControllerPath
        {
            get { return x264farmControllerPath; }
            set { x264farmControllerPath = value; }
        }
		/// <summary>
