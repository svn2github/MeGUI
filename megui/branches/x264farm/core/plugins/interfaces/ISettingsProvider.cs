...
using MeGUI.packages.video.x264farm;
...
*/
    ...
    public class X264FARMSettingsProvider : SettingsProviderImpl2<x264farmConfigurationPanel,
        VideoInfo, x264farmSettings, VideoCodecSettings, VideoCodec, VideoEncoderType>
    {
        public X264FARMSettingsProvider()
            : base("x264Farm", VideoEncoderType.X264FARM, VideoCodec.AVC)
        {
        }
        public override string EncoderPath(MeGUISettings settings)
        {
