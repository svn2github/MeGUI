        ...
        where TJob : Job
    {
        ...
        public void start()
        {
            ...
            try
            {
                ...
                isProcessing = true;
                new Timer(hideMainWindow, null, 2500, Timeout.Infinite);
        ...
        private void hideMainWindow(object o)
        {
            while (proc.MainWindowHandle == IntPtr.Zero)
                Thread.Sleep(1000);

            windowHandle = proc.MainWindowHandle;
            WindowUtil.ShowWindowAsync(windowHandle, WindowUtil.ShowState.Minimize);
            WindowUtil.ShowWindowAsync(windowHandle, WindowUtil.ShowState.Hide);
