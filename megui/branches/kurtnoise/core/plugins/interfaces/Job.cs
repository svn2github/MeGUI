...
namespace MeGUI
{
    ...
    XmlInclude(typeof(CleanupJob)), XmlInclude(typeof(DGAIndexJob)), XmlInclude(typeof(DGVIndexJob)),
    XmlInclude(typeof(DGMIndexJob)), XmlInclude(typeof(HDStreamsExJob))]
