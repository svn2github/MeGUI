...
namespace MeGUI
{
	public enum AspectRatio: int {A16x9 = 0, A4x3, A1x1, CUSTOM};
...
#warning Why load the video here? This means that we can't apply force film unless the video unless it is playable in AviSynth
        public d2vReader(string fileName)
		{
				...
				while ((line = sr.ReadLine()) != null)
				{
					if (line.IndexOf("Aspect_Ratio") != -1) // this is the aspect ratio line
					{
                        ...
                        if (ar.Equals("16:9"))
                        {
                            this.darX = 16;
                            this.darY = 9;
                            this.aspectRatio = AspectRatio.A16x9;
                        }
                        else if (ar.Equals("4:3"))
                        {
                            this.darX = 4;
                            this.darY = 3;
                            this.aspectRatio = AspectRatio.A4x3;
                        }
