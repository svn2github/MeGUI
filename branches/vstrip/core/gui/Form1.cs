...
using MeGUI.packages.tools.dvddecrypter;
...
//            PackageSystem.JobProcessors.Register(Muxer.Factory);
            ...
            PackageSystem.JobProcessors.Register(DVDDecrypterRunner.Factory);
...
//            PackageSystem.MuxerProviders.Register(new DivXMuxProvider());
            ...
            PackageSystem.Tools.Register(new DVDDecrypterFactory());
//            PackageSystem.Tools.Register(new OneClickConfigTool());
        ...
        {
            DVDFile d = DVDFile.Open(@"D:\DVDs\ASSASS_RICHARD_NIXON\VIDEO_TS\vts_02_0.ifo");
