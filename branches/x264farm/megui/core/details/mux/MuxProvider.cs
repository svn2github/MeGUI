...
//            base.videoInputFilter = "RAW MPEG-4 AVC Files (*.264)|*.264";
    ...
    public class VideoEncoderProvider : AllEncoderProvider<VideoCodec, VideoType, VideoEncoderType>
    {
            ...
            : base()
        {
            ...
            this.RegisterEncoder(new X264FARMEncoderProvider());
    ...
    public class X264FARMEncoderProvider : EncodingProvider<VideoCodec, VideoType, VideoEncoderType>
    {
        public X264FARMEncoderProvider()
        {            
            supportedTypes.Add(VideoType.MKV);         
            supportedEncoderTypes.Add(VideoEncoderType.X264FARM);
        }

        public override IJobProcessor CreateEncoder(MeGUISettings settings)
        {
            return new x264farmEncoder(settings.X264farmControllerPath);
        }
    }
