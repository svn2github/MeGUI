...
namespace MeGUI
{
	...
	/// </summary>
    [XmlInclude(typeof(lavcSettings)), XmlInclude(typeof(x264Settings)), XmlInclude(typeof(x264farmSettings)), XmlInclude(typeof(snowSettings)), XmlInclude(typeof(xvidSettings)), XmlInclude(typeof(hfyuSettings))]
    public abstract class VideoCodecSettings : MeGUI.core.plugins.interfaces.GenericSettings
	{
        ...
        public bool matchesType(string s)
        {
            return s == getSettingsType() || s == (getSettingsType() + ":" + EncoderType.ID);
        }
