...
namespace MeGUI
{
	...
	public class Calculator : System.Windows.Forms.Form
	{
		...
		public Calculator()
		{
            ...
            this.audio1Type.Items.AddRange(ContainerManager.GetContainerManager().AudioTypes);
            this.audio2Type.Items.AddRange(ContainerManager.GetContainerManager().AudioTypes);
            videoCodec.SelectedItem = CodecManager.X264;
            this.containerFormat.Items.AddRange(muxProvider.GetSupportedContainers().ToArray());
            containerFormat.SelectedItem = ContainerFileType.MKV;
		...
		{
    		openFileDialog.Filter = VideoUtil.GenerateCombinedFilter(ContainerManager.GetContainerManager().AudioTypes);
        ...
        private void updateContainers()
        {
            ...
            ContainerFileType previousContainer = null;
            try 
            {
                previousContainer = containerFormat.SelectedItem as ContainerFileType;
            }
            catch (Exception) {}
            ...
            out int numberOfFrames, out double framerate)
        {
            ...
            try
            {
                ...
                containerType = (containerFormat.SelectedItem as ContainerFileType).ContainerType;
            }
            catch (Exception)
            {
