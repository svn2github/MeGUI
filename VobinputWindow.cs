...
namespace MeGUI
{
	...
	public class VobinputWindow : System.Windows.Forms.Form
	{
		...
		public VobinputWindow(MeGUI mainForm)
		{
			InitializeComponent();
		...
		public VobinputWindow(MeGUI mainForm, string fileName): this(mainForm)
		{
			openVideo(fileName);
		}

        public VobinputWindow(MeGUI mainForm, string fileName, bool autoReturn) : this(mainForm, fileName)
        {
            openVideo(fileName);
