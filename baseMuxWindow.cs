...
namespace MeGUI
{
    ...
    public class baseMuxWindow : System.Windows.Forms.Form
    {
        ...
        public baseMuxWindow(MeGUI mainForm)
            : this()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.subtitleGroupbox.Location = new System.Drawing.Point(8, 184);
            ...
            this.audioGroupbox.Location = new System.Drawing.Point(8, 96);
            ...
            this.chaptersGroupbox.Location = new System.Drawing.Point(8, 264);
            ...
            this.outputGroupbox.Location = new System.Drawing.Point(8, 318);
        ...
        protected virtual bool isFPSRequired()
        {
            try
            {
                if (videoInput.Text.Length > 0)
                    return (VideoUtil.guessVideoType(videoInput.Text).ContainerType == ContainerType.NONE);
                return true;
            }
